...
# Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7468502413:AAETg3EcPfwYiUvVqZQ3W7AAkwizRA3qCvQ")
...
# Database
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://gojo:gojo@gojo.f4eez.mongodb.net/?retryWrites=true&w=majority&appName=Gojo")
JOIN_REQS_DB = environ.get("JOIN_REQS_DB", DB_URI)
DB_NAME = os.environ.get("DATABASE_NAME", "Gojo")

# Force sub channel ID, if you want to enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1001983923805"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002254296068"))
